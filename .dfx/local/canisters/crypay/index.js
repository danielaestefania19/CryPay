...
import { idlFactory } from './crypay.did.js';
export { idlFactory } from './crypay.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CRYPAY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./crypay.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the crypay canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./crypay.did.js")._SERVICE>}
 */
export const crypay = createActor(canisterId);
